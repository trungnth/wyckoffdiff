...
It can be noted that the code also supports the case of the data having been generated by other models we compared to in the paper (CDVAE, DiffCSP++, SymmCD).
